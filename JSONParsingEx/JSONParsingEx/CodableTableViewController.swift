//
//  CodableTableViewController.swift
//  JSONParsingEx
//
...
class CodableTableViewController: UITableViewController {
    var bts:[Member] = []
    ...
    func parsing(){
        ...
        do{
            let root = try decoder.decode(BTSData.self, from: jsonData)
            self.bts = root.bts
        } catch {
            print("파싱실패")
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let member:Member = bts[indexPath.row]
